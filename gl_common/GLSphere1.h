...
class GLSphere1 : public GLObject
{
public:
    /*!
     Constructor
    ...
    */
    GLSphere1(float center_x, float center_y, float center_z, float radius, int rows = 10, int segments = 10 );
...
protected:
    ...
    /*
     Creates a sphere
     */
    void make_Sphere(Vertex center, double r, std::vector<Vertex> &spherePoints, std::vector<Vertex> &normals, std::vector<Vertex> &coords);
